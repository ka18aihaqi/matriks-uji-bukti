        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @endif
                    <form action="{{ route('perekaman.update', $pemeriksaan->id) }}" method="POST" class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="relative z-0 w-full group">
                            <input type="text" name="nama_wajib_pajak" id="nama_wajib_pajak" placeholder=" " required
                                value="{{ old('nama_wajib_pajak', $pemeriksaan->nama_wajib_pajak) }}"
                        ...
                        <div class="relative z-0 w-full group">
                            <input type="text" name="npwp" id="npwp" placeholder=" " required
                                value="{{ old('npwp', $pemeriksaan->npwp) }}"
                                class="peer block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600" />
                        ...
                        <div class="relative z-0 w-full group">
                            <input type="text" name="tahun_pajak" id="tahun_pajak" placeholder=" " maxlength="4" required
                                value="{{ old('tahun_pajak', $pemeriksaan->tahun_pajak) }}"
                                class="peer block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600" />
                        ...
                        <div class="relative z-0 w-full group">
                            <input type="text" name="nomor_sp2" id="nomor_sp2" placeholder=" " required
                                value="{{ old('nomor_sp2', $pemeriksaan->nomor_sp2) }}"
                                class="peer block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600" />
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <select name="pos_uji_id" id="pos_uji_id"
                                ...
                                @foreach ($posUjiOptions as $option)
                                    <option value="{{ $option->id }}" {{ $pemeriksaan->pos_uji_id == $option->id ? 'selected' : '' }}>{{ $option->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <select name="jenis_bukti_id" id="jenis_bukti_id"
                                ...
                                @foreach ($jenisBuktiOptions as $option)
                                    <option value="{{ $option->id }}" {{ $pemeriksaan->jenis_bukti_id == $option->id ? 'selected' : '' }}>{{ $option->jenis }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <select name="dokumen_sumber_id" id="dokumen_sumber_id"
                                ...
                                @foreach ($dokumenSumberOptions as $option)
                                    <option value="{{ $option->id }}" {{ $pemeriksaan->dokumen_sumber_id == $option->id ? 'selected' : '' }}>{{ $option->dokumen }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <select name="metode_id" id="metode_id"
                                ...
                                @foreach ($metodeOptions as $option)
                                    <option value="{{ $option->id }}" {{ $pemeriksaan->metode_id == $option->id ? 'selected' : '' }}>{{ $option->metode }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <select name="teknik_id" id="teknik_id"
                                ...
                                @foreach ($teknikOptions as $option)
                                    <option value="{{ $option->id }}" {{ $pemeriksaan->teknik_id == $option->id ? 'selected' : '' }}>{{ $option->teknik }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="relative z-0 w-full group">
                            <input type="text" name="supervisor" id="supervisor" placeholder=" " required
                                value="{{ old('supervisor', $pemeriksaan->supervisor) }}"
                                class="peer block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600" />
                        ...
                        <!-- Submit Button -->
                        <div class="lg:col-span-3 text-center mt-6 flex justify-center gap-4">
                            <a href="{{ route('dashboard') }}"
                            class="text-white bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5">
